...
<body>
    <div class="container">
        <h2>Edit Article</h2>
        <form action="<?php echo base_url('pages/updateNowV/' . $article->slug) ?>" method="POST" enctype="multipart/form-data">
    ...
    <select id="volume" name="volume_id" class="form-control" required>
        ...
        <?php endforeach; ?>
            ...
            <button type="button" class="cancel-button" onclick="window.location.href='<?php echo base_url('pages/viewArticle' . $article->articleid)?>'">Cancel</button>
